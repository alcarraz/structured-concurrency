...
\subsection{Virtual Threads: M:N Mapping}
\begin{frame}
...
\subsection{Virtual Threads: La Base de Structured Concurrency}
\begin{frame}[plain]
\small
...
\subsection{El Problema: Procesamiento de Transacción Financiera}
\begin{frame}
\begin{center}
