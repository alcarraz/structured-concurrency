\section{El Problema: Reactive Programming}\label{sec:el-problema:-reactive-programming}
...
public CompletableFuture<TransactionResult> processTransaction(TransactionRequest request) {
    return CompletableFuture
        ...
        .thenCompose(cardResult -> {
            ...
            // xxx más validaciones paralelas
...
\begin{frame}
\frametitle{Problemas del Approach Reactivo}
