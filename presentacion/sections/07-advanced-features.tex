\section{Features Avanzados}\label{sec:features-avanzados}
...
\subsection{Nested Scopes: Composición Jerárquica}
\begin{frame}[fragile]
...
\subsection{Timeout Patterns: Deadlines con Structured Concurrency}
\begin{frame}[fragile]
