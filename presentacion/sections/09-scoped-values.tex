...
\begin{exampleblock}{$\blacktriangleright$ ¡Scoped Values son ESTABLES en Java 25!}
No más ThreadLocal ni parameter drilling. 
\textcolor{green}{\textbf{JEP 506}}: ¡Propagación automática de contexto pronta para usar en producción!
\end{exampleblock}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
        \Large{Propagación de contexto automática}
    \end{center}
    ...
    \begin{exampleblock}{¿Qué veremos?}
        \begin{itemize}
            ...
            \item Integración perfecta con Concurrencia Estructurada.
        \end{itemize}
    \end{exampleblock}

    \begin{alertblock}{Sin Scoped Values}
        \textbf{Necesitarías:}
        Pasar datos del \texttt{TransactionRequest} como parámetros a cada método, o usar ThreadLocal (problemático con hilos virtuales masivos).
    \end{alertblock}
\end{frame}
